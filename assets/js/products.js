...
const productCatalog = [
  { id:1,  name:"SS 304L Buttweld 90° Elbow",            category:"instruments-fittings",      emoji:"📐", description:"Seamless long radius elbow for industrial piping.",                          specs:"Standard: ASME B16.9 · Sch 10–80 · Size: ½\" to 24\"" },
  { id:2,  name:"SS 316L Buttweld Tee",                   category:"instruments-fittings",      emoji:"⊤",  description:"Equal and unequal tee junctions for fluid distribution.",                  specs:"ASTM A403 WP316L · Seamless/Welded · Sch 40/80" },
  { id:3,  name:"SS Concentric Reducer",                  category:"instruments-fittings",      emoji:"⧓", description:"Symmetrical reducer for vertical piping transitions.",                       specs:"Size: ½\"×¼\" to 12\"×10\" · Sch 10s to 80s" },
  { id:4,  name:"SS Eccentric Reducer",                   category:"instruments-fittings",      emoji:"⧗", description:"Asymmetrical reducer for horizontal piping to prevent air pockets.",         specs:"Material: SS304/316 · Standard: ASME B16.9" },
  { id:5,  name:"SS Stub End (Lap Joint)",                category:"instruments-fittings",      emoji:"⊣", description:"Used with lap joint flanges for easy disassembly.",                         specs:"Type: Short/Long Pattern · Material: SS316L" },
  { id:6,  name:"Hex Long Nipple",                        category:"instruments-fittings",      emoji:"🔩", description:"Threaded connection for joining two internal threads.",                     specs:"Threads: NPT/BSP · Length: 50–300mm · Material: SS316" },
  { id:7,  name:"Double Ferrule Male Connector",          category:"instruments-fittings",      emoji:"🔗", description:"Instrumentation-grade leak-proof tube fitting.",                            specs:"Pressure: 6000 PSI · Material: SS316 · Tube OD: ⅛\" to 1\"" },
  { id:8,  name:"Double Ferrule Union Tee",               category:"instruments-fittings",      emoji:"⫽", description:"Connects three tubes in instrumentation systems.",                          specs:"Design: Compression Type · Material: SS316/304" },
  { id:9,  name:"Bulkhead Male Connector",                category:"instruments-fittings",      emoji:"🧱", description:"Used for passing tubing through panels or bulkheads.",                     specs:"Size: 6–25mm · Material: SS316/Brass" },
  { id:10, name:"Swivel Female Adapter",                  category:"instruments-fittings",      emoji:"🔄", description:"Adapts rigid tube to flexible connections.",                                specs:"Thread: JIC/NPT · Material: SS316" },
  { id:11, name:"Hex Reducing Bushing",                   category:"instruments-fittings",      emoji:"💠", description:"Reduces female thread size to a smaller male size.",                       specs:"Max Pressure: 10000 PSI · Material: ASTM A276" },
  { id:12, name:"Pipe Cap (Buttweld)",                    category:"instruments-fittings",      emoji:"🧢", description:"Used for permanently sealing the end of a pipe.",                          specs:"Standard: ANSI B16.9 · Material: SS304/316" },
  { id:13, name:"Socket Weld Elbow 90°",                  category:"instruments-fittings",      emoji:"📐", description:"High-pressure forged fitting for small bore piping.",                      specs:"Class: 3000/6000/9000 · Standard: ASME B16.11" },
  { id:14, name:"Socket Weld Full Coupling",              category:"instruments-fittings",      emoji:"🍱", description:"Connects two pipes of the same size using socket welds.",                  specs:"Material: ASTM A182 F304/316" },
  { id:15, name:"Threaded Union (Class 3000)",            category:"instruments-fittings",      emoji:"💍", description:"Allows for easy disconnection of piping for maintenance.",                  specs:"Threads: NPT/BSPT · Standard: MSS SP-83" },
  ...
  { id:59, name:"Carbon Steel A105 Forged Elbow",         category:"instruments-fittings",      emoji:"🏗️", description:"Heavy-duty forged fitting for high-pressure steam.",                       specs:"Class: 3000 · Standard: ASME B16.11 · Size: ¼\" to 4\"" },
  { id:60, name:"SS 316 Double Ferrule Equal Cross",      category:"instruments-fittings",      emoji:"✢",  description:"Connects four tubes in a cross configuration.",                            specs:"Material: ASTM A276 SS316 · Max Pressure: 6000 PSI" },
  { id:61, name:"SS 304 Slip-On Flange",                  category:"instruments-fittings",      emoji:"💿", description:"Standard flange for easy alignment and welding.",                          specs:"Class: 150/300 · Standard: ANSI B16.5" },
  { id:62, name:"Weld Neck Flange (SS316)",               category:"instruments-fittings",      emoji:"👔", description:"Preferred for high-stress and critical system applications.",               specs:"Schedule: 40/80/160 · RF (Raised Face)" },
  { id:63, name:"Blind Flange (Carbon Steel)",            category:"instruments-fittings",      emoji:"🌑", description:"Used for sealing the end of a flanged piping system.",                     specs:"Standard: ASME B16.5 · Coating: Anti-rust Oil" },
  { id:64, name:"SS 304 Seamless Pipe (Sch 40)",          category:"instruments-fittings",      emoji:"📊", description:"General purpose industrial piping.",                                       specs:"ASTM A312 · Length: 6m · Size: ½\" to 12\"" },
  { id:65, name:"Brass Hex Nipple",                       category:"instruments-fittings",      emoji:"🟡", description:"Economical threaded connector for low pressure.",                          specs:"Material: Extruded Brass · Thread: BSP" },
  ...
  { id:80, name:"Gauge Snubber (SS316)",                  category:"instruments-fittings",      emoji:"📉", description:"Protects pressure gauges from pressure spikes and surges.",                specs:"Connection: ½\" NPT · Material: SS316 · Type: Adjustable" },
  { id:81, name:"Siphon (Q-Type / U-Type)",               category:"instruments-fittings",      emoji:"➰", description:"Protects gauges from high-temperature steam damage.",                       specs:"Material: Carbon Steel/SS316 · Max Temp: 400°C" },
  { id:82, name:"Thermowell (Bar Stock)",                  category:"instruments-fittings",      emoji:"🌡️", description:"Protective housing for industrial temperature sensors.",                    specs:"Type: Flanged/Screwed · Insertion Length: 100–500mm" },
  { id:83, name:"Condensate Pot",                         category:"instruments-fittings",      emoji:"🏺", description:"Captures condensate and protects instruments in steam lines.",               specs:"Material: Seamless Pipe A106 Gr.B · Pressure: 3000 PSI" },
  { id:84, name:"Air Header / Distribution Manifold",     category:"instruments-fittings",      emoji:"🍴", description:"Centralized distribution point for multiple air instruments.",               specs:"Inlet: 1\" · Outlets: 4–12 Nos (¼\" Ball Valves)" },
  { id:85, name:"Orifice Plate (SS316)",                  category:"instruments-fittings",      emoji:"💿", description:"Primary flow element for differential pressure flow meters.",               specs:"Type: Concentric · Material: SS316 · Standard: ISO 5167" },
  { id:86, name:"Venturi Tube",                           category:"instruments-fittings",      emoji:"⏳", description:"High-accuracy flow measurement device for large pipelines.",                specs:"Material: Cast Iron/SS · Low Pressure Loss" },
  { id:87, name:"Magnetic Level Gauge",                   category:"instruments-fittings",      emoji:"📏", description:"Safe visual level indication for high-pressure tanks.",                    specs:"Body: SS316 · Indicator: Bi-Color Flappers · C-C: Custom" },
  { id:88, name:"Sight Flow Indicator (Double Window)",   category:"instruments-fittings",      emoji:"👁️", description:"Visual inspection tool for flow monitoring.",                              specs:"Glass: Toughened Borosilicate · End: Flanged/Screwed" },
  ...
  { id:93, name:"SS 304 Forged Tee (Threaded)",           category:"instruments-fittings",      emoji:"⊤",  description:"High-pressure threaded branch connection.",                                specs:"Class: 3000 · Standard: ASME B16.11" },
  { id:94, name:"SS Pipe Cross",                          category:"instruments-fittings",      emoji:"✢",  description:"Connects four pipelines at right angles.",                                 specs:"Sch 40 · Seamless · Grade 316" },
  { id:95, name:"SS Socket Weld Union",                   category:"instruments-fittings",      emoji:"💍", description:"Facilitates easy removal of line components.",                             specs:"Class 3000 · Standard ASME B16.11" },
  { id:96, name:"SS Concentric Swage Nipple",             category:"instruments-fittings",      emoji:"🍾", description:"Reducing nipple for connecting buttweld to threaded.",                     specs:"Material: A182 F316 · Length: 100mm" },
  { id:97, name:"Alloy Steel Pipe Fitting (WP11)",        category:"instruments-fittings",      emoji:"🩶", description:"For high-temperature power plant piping.",                                  specs:"Material: ASTM A234 WP11 · CL1/CL2" },
  ...
  { id:124,name:"Instrument Tube & Pipe Fittings",        category:"instruments-fittings",      emoji:"🔩", description:"Twin ferrule compression tube fittings and screwed pipe fittings.",            specs:"Rating: 6000 PSI · Temp: −150°C to 400°C · Tube OD: 1/16\"–1\" · Material: SS/CS/Brass/Monel" },
  { id:125,name:"PANAM Pipe Adaptor (PA Series)",         category:"instruments-fittings",      emoji:"🔌", description:"Male to Female pipe thread adaptors for high-pressure instrumentation connections.", specs:"Pressure: Up to 10,000 PSI · Threads: NPT/BSPP/BSPT · Size: ⅛\"–2\" · Material: SS316/CS/Brass/Monel/Hastelloy" },
  { id:126,name:"PANAM Pipe Reducing Adaptor (PRA)",      category:"instruments-fittings",      emoji:"📉", description:"Male to Female thread reducing adaptors for smooth line transitions.",         specs:"Pressure: Up to 10,000 PSI · Threads: NPT/ISO Tapered · Size: ⅛\"×¼\" to 2\"×1½\" · Material: SS316/CS/Alloy 400" },
  { id:127,name:"PANAM Pipe Reducing Bushing (PRB)",      category:"instruments-fittings",      emoji:"🪙", description:"Hexagonal male-to-female reducing bushings for compact thread size reduction.", specs:"Pressure: Up to 10,000 PSI · Threads: NPT/BSPT/BSPP · Size: ¼\"M × ⅛\"F to 2\"M × 1½\"F · Material: SS316/304/CS" },
];
...
function render() {
    ...
    // Apply sort
    if (currentSort === 'az') results.sort((a, b) => a.name.localeCompare(a.name));
